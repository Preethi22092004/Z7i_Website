...
const JRSMProgramClass10 = () => {
  return (
    <div className="program-container">
      <div className="program-header">
        <Container>
          <h1 className="text-center">Junior Rankers Study Material (JRSM)</h1>
          <h2 className="text-center">One Year Foundation Program For Students Moving from Class IX to X</h2>
        </Container>
      </div>
      ...
      <Container>
        <div className="cards-grid">
          <Card className="program-card">
            ...
            <Card.Body>
              <p>The Junior Rankers Study Material (JRSM) is a meticulously designed one-year foundation program aimed at students entering Class X. This non-classroom correspondence course is tailored to build a strong academic foundation, preparing students for competitive exams such as NEET, JEE Main & Advanced, NTSE, and Junior Science Olympiads, alongside excelling in school and board examinations.</p>
            </Card.Body>
          </Card>
          ...
          <Card className="program-card">
            ...
            <Card.Body>
              <ul className="feature-list">
                <li>Eligibility: Students moving from Class IX to X.</li>
                <li>Enrollment Process:
                  <ol>
                    <li>Visit the official Z7i Non-Classroom Programs website: www.z7inonclassroomprograms.com</li>
                    <li>Select the Junior Rankers Study Material (JRSM) – One Year Foundation Program.</li>
          ...
          <Card className="program-card">
            ...
            <Card.Body>
              <ul className="feature-list">
                <li>Books Fee: Rs. 6,000/-</li>
                <li>Junior All India Test Series Fee: Rs. 3,965/- (Rs. 3,360 + 18% GST)</li>
                <li>myPAT Online Test Series Fee: Rs. 3,539/- (Rs. 2,999 + 18% GST)</li>
                <li>Total Amount: Rs. 13,504/-</li>
              </ul>
              <p>Note: For Program Code 1095, the myPAT Online Test Series is not included, and the total amount is Rs. 9,965/-.</p>
            </Card.Body>
          </Card>
...
export default JRSMProgramClass10; 