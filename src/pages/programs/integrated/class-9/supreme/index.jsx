  ...
  return (
    <div className="program-container">
      <div className="program-header">
        <Container>
          <h1 className="text-center">SUPREME - Four-Year Integrated School Program</h1>
          ...
          <Card className="program-card">
            ...
            <Card.Body>
              <ul className="feature-list">
                ...
                <li>Class Learning Improvement Program (CLIP): Additional sessions for students who have completed all assignments</li>
                <li>JEE Archive: Access to a comprehensive question bank with answers from previous years' JEE papers</li>
              </ul>
            </Card.Body>
          </Card>
        </div>
