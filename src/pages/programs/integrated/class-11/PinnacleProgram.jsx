...
const PinnacleProgram = () => {
  return (
    <div className="program-container">
      <div className="program-header">
        <Container>
          <h1 className="text-center">PINNACLE – Two Year Integrated School Program</h1>
          <h2 className="text-center">For Students Moving from Class X to XI</h2>
        </Container>
      </div>
          ...
          <Card className="program-card">
            ...
            <Card.Body>
              <ul className="feature-list">
                ...
                <li>Phases:
                  <ul>
                    <li>Class XI: 4 Phases</li>
                    <li>Class XII: 4 Phases</li>
                  </ul>
                </li>
                <li>Subjects Covered:
                  <ul>
                ...
                <li>Contact Hours: Approximately 1,364 hours (Class XI: 690 hrs, Class XII: 674 hrs)</li>
              </ul>
            </Card.Body>
          </Card>
...
export default PinnacleProgram; 